...
const NeverHaveIEverPlay = () => {
  ...
  const qrpro = require('../../asset/QR/BDTCPRO.png')
  const qrpromax = require('../../asset/QR/BDTCPROMAX.png')
  ...
  AsyncStorage.getItem('isBuyBDTCPRO')
    .then((value) => {
      console.log(value)
  ...
  AsyncStorage.getItem('isBuyBDTCPROMAX')
    .then((value) => {
      console.log(value)
  ...
  const handleSubmitCode = () => {
    if (codeInput === 'Cakgame-010401') {
      AsyncStorage.setItem('isBuyBDTCPRO', 'true');
      setShowExtraContent(false);
      Alert.alert('Thông báo', 'Mã code hợp lệ');
    } else if (codeInput === 'Cakgame-010402') {
      AsyncStorage.setItem('isBuyBDTCPROMAX', 'true');
      setShowExtraContent(false);
      Alert.alert('Thông báo', 'Mã code hợp lệ');
    }
    else {
